<%-- 
    Document   : DTH
    Created on : 19 Dec, 2021, 9:55:06 PM
    Author     : Yadav
--%>
...
<body>  
    ...
    <h2 style="padding-left:50px;">DTHRecharge</h2><br> 
...
<hr>		
        ...
        <input type="text" name="type" id="type" placeholder="Recharge Type" value="DTH" style="font-size:20px;" required />	
        <br><br> 
        ...
        <input type="text" name="circle" id="circle" placeholder="Location" style="font-size:20px;" required/>		
        <br><br> 
		 		
		<label><b>Amount : 
        </label>    
        <input type="number" name="num" id="num" placeholder="Amount" required style="font-size:20px;"/>	
        <br><br> 
...
final String stringDate = dateFormat.format(utilDate);
   ...
   ps.setString(3,type);
     ...
     out.println("<div style='color:#FF5800;  font-size:35px; padding-left:400px;'>Recharge Done Successfully</div>");
      }
       else{
