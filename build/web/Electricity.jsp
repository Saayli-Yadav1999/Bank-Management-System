<%-- 
    ...
    Created on : 19 Dec, 2021, 9:51:41 PM
    Author     : Yadav
--%>
...
<body> 
    ...
    <h2 style="padding-left:50px;color:#FF5800; ">Electricity Bill</h2><br> 
    ...
    <form id="login" name="login" method="post">    
        ...
        <input type="text" name="bill_name" id="bill_name" placeholder="Bill Name " value="Electricity Bill" style="font-size:20px;" required>
        <br><br> 
        ...
        <input type="number" name="unit" id="unit" placeholder="Unit Number" style="font-size:20px;" required/>	
        <br><br> 
		<label><b>Amount  
        </label> <br>   
...
ResultSet rs=st.executeQuery("select accno from bills where accno='"+accnumber+"' ");
try{
 if (balance>0){
    String sql="insert into bills(accno,bill_name,cons_number,unit_code,date,amount) values(?,?,?,?,?,?)";
    PreparedStatement ps=con.prepareStatement(sql);
    
    
    
    String bill_name = "Electricity Bill";
    String cons_number =request.getParameter("cons_number");
    String unit_code = request.getParameter("unit");
...
final String stringDate = dateFormat.format(utilDate);
     ...
     out.println("<div style='color:#FF5800;   font-size:35px; padding-left:0px;'>  Bill Paid Successfully</div>");
 }
 else{
          out.println("<div style='color:#FF5800;  font-size:35px; padding-left:0px;'> out of balance </div>");
      }
}
catch (Exception e) {
e.printStackTrace();
