...
<%@include file="menu1.html" %>
 <% 
    ...
    session.setAttribute("accnumber",accnumber);
     ...
     int wallet=(Integer)session.getAttribute("wallet");
    session.setAttribute("balance",wallet);
...
<body>
    ...
    <h2 style="padding-left:0px;color:#FF5800;">Withdraw</h2><br> 
    ...
    <form id="login" name="login" method="post">    
        ...
        <input type="submit" name="log" id="log" value="Withdraw" style="font-size:20px;"/>       
        <br><br>    
...
final String stringDate = dateFormat.format(utilDate);
    ...
    String action="withdraw";
     ...
     out.println("<div style='color:#FF5800;  font-size:35px; padding-left:400px;'> successfull </div>");
     }
      else{
